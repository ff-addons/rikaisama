...
pref('rikaichan.wmax', 7);
pref('rikaichan.wpos', 1);
pref('rikaichan.wpop', 1);

pref('rikaichan.kindex', 'COMP,H,L,E,DK,N,V,Y,P,IN,I,U');

pref('rikaichan.nadelay', 0);
